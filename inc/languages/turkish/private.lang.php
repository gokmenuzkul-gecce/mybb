...
$l['archive_messages'] = "Export Özel Mesajlar";
...
$l['delete_archived'] = "Sil Exported Messages?";
...
$l['private_messages_for'] = "Özel Mesajlar for {1}";
...
$l['empty_note'] = "Here you can delete private messages from selected folders at one time. Simply select the folders you wish the messages to be deleted from and click 'Sil'. You cannot undo these changes.<br /><strong>Note: Once these messages are deleted there is no way to recover them.</strong>";
...
$l['update_folders'] = "Güncelle Folders";
...
$l['options_save_copy'] = "<strong>Kaydet a Copy:</strong> save a copy of this message in your Sent Items folder.";
...
$l['delete_title'] = "Sil this private message";
...
$l['search_private_messages'] = "Search Özel Mesajlar";
...
$l['quickreply_save_copy'] = "Kaydet a Copy";
