...
$l['nav_deletethread'] = "Sil Thread Permanently";
$l['nav_deletepoll'] = "Sil Poll";
$l['nav_deleteposts'] = "Sil Selective Gönderiler";
$l['nav_mergeposts'] = "Merge Selective Gönderiler";
...
$l['nav_merge'] = "Merge Konular";
$l['nav_split'] = "Split Thread";
$l['nav_multi_deletethreads'] = "Inline Thread Deletion";
$l['nav_multi_deleteposts'] = "Inline Post Deletion";
$l['nav_multi_splitposts'] = "Split Selected Gönderiler";
$l['nav_multi_moveposts'] = "Move Selected Gönderiler";
$l['nav_multi_mergeposts'] = "Merge Selected Gönderiler";
$l['nav_multi_movethreads'] = "Move / Copy Konular";
...
$l['delete_posts'] = "Sil Gönderiler Permanently";
$l['delete_selected_posts'] = "Sil Selected Gönderiler";
...
$l['merge_posts'] = "Merge Gönderiler";
...
$l['thread_deleted'] = "Thread Sild Permanently: {1}";
$l['poll_deleted'] = "Poll Sild: {1}";
$l['thread_approved'] = "Thread Approved: {1}";
$l['thread_unapproved'] = "Thread Unapproved: {1}";
$l['thread_restored'] = "Thread Restored: {1}";
$l['thread_soft_deleted'] = "Thread Soft Sild: {1}";
$l['deleted_selective_posts'] = "Sild Selective Gönderiler ({1})";
$l['merged_selective_posts'] = "Merged Selective Gönderiler";
...
$l['thread_merged'] = "Konular Merged";
$l['thread_split'] = "Thread Split";
$l['thread_notes_edited'] = "Thread Notes Edited";
$l['multi_deleted_threads'] = "Konular Sild Permanently";
$l['multi_opened_threads'] = "Konular Opened";
$l['multi_closed_threads'] = "Konular Closed";
$l['multi_approved_threads'] = "Konular Approved";
$l['multi_unapproved_threads'] = "Konular Unapproved";
$l['multi_restored_threads'] = "Konular Restored";
$l['multi_soft_deleted_threads'] = "Konular Soft Sild";
$l['multi_approve_posts'] = "Selected Gönderiler Approved";
$l['multi_unapprove_posts'] = "Selected Gönderiler Unapproved";
$l['multi_restore_posts'] = "Selected Gönderiler Restored";
$l['multi_soft_delete_posts'] = "Selected Gönderiler Soft Sild";
$l['multi_stuck_threads'] = "Konular Stuck";
$l['multi_unstuck_threads'] = "Konular Unstuck";
$l['multi_moved_threads'] = "Konular Moved / Copied";
$l['multi_copied_threads'] = "Konular Copied";
...
$l['softdelete_restore_thread'] = "Soft Sil/Restore Thread";
$l['stick_unstick_thread'] = "Stick/Unstick Thread";
$l['save_delayed_moderation'] = "Kaydet Delayed Moderation";
$l['custom'] = "custom";
...
$l['multiple_threads'] = "Multiple Konular";
$l['actions'] = "Actions";
$l['cancel'] = "İptal";
...
$l['error_mergewithself'] = "Konular cannot be merged with themselves.<br />Please go back and enter a valid URL.";
$l['error_movetoself'] = "Gönderiler cannot be moved to the thread they are in.<br />Please go back and enter a valid URL.";
...
$l['redirect_pollnotdeleted'] = "The poll was not deleted because you did not check the \"Sil\" checkbox.";
