...
$l['ucp_nav_favorite_threads'] = "Favorite Konular";
$l['ucp_nav_subscribed_threads'] = "Subscribed Konular";
$l['ucp_nav_forum_subscriptions'] = "Forum Subscriptions";
$l['ucp_nav_drafts'] = "Kaydetd Drafts";
$l['ucp_nav_drafts_active'] = "<strong>Kaydetd Drafts ({1})</strong>";
