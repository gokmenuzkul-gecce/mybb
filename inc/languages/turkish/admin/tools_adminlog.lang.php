...
$l['admin_log_config_attachment_types_delete'] = "Sild attachment extension #{1} ({2})";
...
$l['admin_log_config_badwords_delete'] = "Sild word filter #{1} ({2})";
...
$l['admin_log_config_calendars_delete'] = "Sild calendar #{1} ({2})";
$l['admin_log_config_calendars_update_order'] = "Güncelled calendar display order";
...
$l['admin_log_config_help_documents_delete_section'] = "Sild help section #{1} ({2})";
$l['admin_log_config_help_documents_delete_document'] = "Sild help document #{1} ({2})";
...
$l['admin_log_config_mod_tools_delete_post_tool'] = "Sild post moderation tool #{1} ({2})";
$l['admin_log_config_mod_tools_delete_thread_tool'] = "Sild thread moderation tool #{1} ({2})";
...
$l['admin_log_config_mycode_delete'] = "Sild custom MyCode #{1} ({2})";
...
$l['admin_log_config_post_icons_delete'] = "Sild post icon #{1} ({2})";
...
$l['admin_log_config_profile_fields_delete'] = "Sild custom profile field #{1} ({2})";

$l['admin_log_config_questions_add'] = "Added question #{1} ({2})";
$l['admin_log_config_questions_edit'] = "Edited question #{1} ({2})";
$l['admin_log_config_questions_delete'] = "Sild question #{1} ({2})";
...
$l['admin_log_config_report_reasons_delete'] = "Sild report reason #{1} ({2})";

$l['admin_log_config_settings_delete_duplicates'] = "Sild duplicate settings and setting groups";
...
$l['admin_log_config_settings_deletegroup'] = "Sild setting group #{1} ({2})";
...
$l['admin_log_config_settings_delete'] = "Sild setting #{1} ({2})";
$l['admin_log_config_settings_manage'] = "Güncelled setting and setting group orders";
...
$l['admin_log_config_smilies_delete'] = "Sild smilie #{1} ({2})";
...
$l['admin_log_config_spiders_delete'] = "Sild spider #{1} ({2})";
...
$l['admin_log_config_thread_prefixes_delete_prefix'] = 'Sild thread prefix #{1} ({2})';
...
$l['admin_log_config_warning_delete_level'] = "Sild warning level #{1} at {2}%";
$l['admin_log_config_warning_add_type'] = "Added warning type #{1} ({2})";
$l['admin_log_config_warning_edit_type'] = "Edited warning type #{1} ({2})";
$l['admin_log_config_warning_delete_type'] = "Sild warning type #{1} ({2})";

$l['admin_log_forum_announcements_add'] = "Added announcement #{1} ({2})";
$l['admin_log_forum_announcements_edit'] = "Edited announcement #{1} ({2})";
$l['admin_log_forum_announcements_delete'] = "Sild announcement #{1} ({2})";

$l['admin_log_forum_attachments_delete_post'] = "Sild attachment #{1} ({2}) from post #{3}";
$l['admin_log_forum_attachments_delete'] = "Sild attachment #{1} ({2})";
$l['admin_log_forum_attachments_delete_orphans'] = "Sild orphaned attachments";
...
$l['admin_log_forum_management_deletemod'] = "Sild moderator #{1} ({2}) from forum #{3} ({4})";
$l['admin_log_forum_management_delete'] = "Sild forum #{1} ({2})";
$l['admin_log_forum_management_orders'] = "Güncelled root forum orders";
$l['admin_log_forum_management_orders_sub'] = "Güncelled forum orders within forum #{2} ({3})";
$l['admin_log_forum_management_addmod'] = "Added moderator #{2} ({3}) to forum #{4} ({5})";
$l['admin_log_forum_management_quickpermissions'] = "Güncelled quick forum permissions for forum #{2} ({3})";
...
$l['admin_log_style_templates_delete_set'] = "Sild template set #{1} ({2})";
$l['admin_log_style_templates_delete_template'] = "Sild template #{1} ({2}) from template set #{3} ({4})";
$l['admin_log_style_templates_delete_template_global'] = "Sild template #{1} ({2}) from the global template set";
...
$l['admin_log_style_templates_delete_template_group'] = "Sild template group #{1} ({2})";
...
$l['admin_log_style_themes_delete_stylesheet'] = "Sild / Reverted stylesheet #{1} ({2}) in theme #{3} ({4})";
...
$l['admin_log_style_themes_delete'] = "Sild theme #{1} ({2})";
...
$l['admin_log_tools_backupdb_delete'] = "Sild a backup: {1}";
...
$l['admin_log_tools_tasks_delete'] = "Sild task #{1} ({2})";
...
$l['admin_log_user_awaiting_activation_activate_deleted'] = "Sild {2} user account(s)";

$l['admin_log_user_admin_permissions_delete_user'] = "Sild administrator permissions for user #{1} ({2})";
$l['admin_log_user_admin_permissions_delete_group'] = "Sild group administrator permissions for usergroup #{1} ({2})";
...
$l['admin_log_user_group_promotions_delete'] = "Sild group promotion #{1} ({2})";
...
$l['admin_log_user_groups_delete'] = "Sild usergroup #{1} ({2})";
$l['admin_log_user_groups_disporder'] = "Güncelled usergroup display orders";
...
$l['admin_log_user_titles_delete'] = "Sild default user title #{1} ({2}) at {3} posts";
...
$l['admin_log_user_users_delete'] = "Sild user #{1} ({2})";
...
$l['admin_log_user_users_inline_delete'] = "Sild {1} user(s)";
...
$l['admin_log_user_mass_mail_delete'] = "Sild mass mail #{1} ({2})";
