...
$l['thread_prefixes_desc'] = "Thread prefixes allow you to define prefixes that users can assign to their threads. Konular can then be filtered by prefix within a forum.";
...
$l['delete_thread_prefix'] = "Sil Thread Prefix";

$l['prefix_options'] = "Prefix Options";
$l['save_thread_prefix'] = "Kaydet Thread Prefix";
