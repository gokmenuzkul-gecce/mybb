...
$l['error_alreadyuploaded'] = "This post already contains an attachment with the name \"{1}\". Please rename the file and upload it again. Alternatively you may click \"Güncelle Attachment\".";
...
$l['login'] = "Giriş yap";
$l['need_reg'] = "Kayıt olmanız mı gerekiyor?";
...
You will need to enter the following:
Kullanıcı adı: {1} (Or your email address)
Activation Code: {5}
...
You will need this password to login to the forums, once you login you should change it by going to your User Yönetim Paneli.
...
Kullanıcı adı: {3} (Or your email address)
Şifre: {4}
...
If you don't want other members to be able to email you please visit your User Yönetim Paneli and enable the option 'Hide your email from other members':
{4}/usercp.php?action=options
