...
$l['login'] = "Giriş yap";
$l['pw_note'] = "Şifrelerde büyük-küçük harf duyarlılığı olduğunu unutmayın.";
$l['lostpw_note'] = "Şifrenizi mi unuttunuz?";
$l['lost_pw'] = "Hesap şifresi kayıp";
$l['lost_pw_form'] = "Şifre kurtarma formu";
$l['email_address'] = "E-posta adresi:";
$l['request_user_pass'] = "Giriş bilgilerini iste";
...
$l['complex_password'] = "<abbr title=\"A password that is at least {1} characters long and contains an upper case letter, a lower case letter and a number.\">Complex</abbr> Şifre:";
$l['confirm_email'] = "Confirm E-posta:";
...
$l['submit_registration'] = "Gönder Registration!";
$l['confirm_password'] = "Confirm Şifre:";
$l['referrer'] = "Referrer:";
...
$l['error_notloggedout'] = "Your user ID could not be verified to proceed with the log out process. This could be due to malicious Javascript that was attempting to log you out automatically.  If you intended to log out, please click the Çıkış Yap button at the top menu.";
